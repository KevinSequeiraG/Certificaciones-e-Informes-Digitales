...
class FactoryConexion
{
    public static string CreateConnection()
    {
        ...
        {
            if (ConfigurationManager.ConnectionStrings[i].Name.Equals("Certificaciones_e_Informes_Digitales.Properties.Settings.CadenaSqlServer", StringComparison.InvariantCultureIgnoreCase))
                existe = true;
        }
        ...
        return ConfigurationManager.ConnectionStrings["Certificaciones_e_Informes_Digitales.Properties.Settings.CadenaSqlServer"].ConnectionString;
    }
    public static string CreateConnection(string pUsuario, String pContrasena)
    {
        ...
        conexion.AppendFormat("{0}", ConfigurationManager.ConnectionStrings["Certificaciones_e_Informes_Digitales.Properties.Settings.CadenaSqlServer"].ConnectionString);
        // Agrega al usuario
